...
class SortTest extends TestCase
{
    ...
    /** @test */
    public function it_orders_by_stock_asc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createProduct();
        ...
        $this->actingAs($admin)->get('/admin/products2?sortColumn=stock&sortDirection=asc')
            ->assertOk()
            ->assertSeeInOrder([$product->name,$product1->name]);
    }

    /** @test */
    public function it_orders_by_stock_desc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createProduct();
        $product1->quantity = 10;
        ...
        $this->actingAs($admin)->get('/admin/products2?sortColumn=stock&sortDirection=desc')
            ->assertOk()
            ->assertSeeInOrder([$product1->name,$product->name]);
    }
    ...
    /** @test */
    public function it_orders_by_colors_asc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createColorProduct();
        $category = $this->createCustomCategory('Audio y altavoces');
        $subcategory = $this->createCustomSubcategory($category->id, 'Audio');
        $brand = $category->brands()->create(['name' => 'Apple']);
        $product = $this->createCustomProduct('Cascos', $subcategory, $brand, 1);
        ...
        $this->actingAs($admin)->get('/admin/products2?sortColumn=colors.name&sortDirection=asc')
            ->assertOk()
            ->assertSeeInOrder([$product->name,$product1->name]);
    }

    /** @test */
    public function it_orders_by_colors_at_desc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createColorProduct();
        $category = $this->createCustomCategory('Audio y altavoces');
        ...
        $this->actingAs($admin)->get('/admin/products2?sortColumn=colors.name&sortDirection=desc')
            ->assertOk()
            ->assertSeeInOrder([$product1->name,$product->name]);
    }

    /** @test */
    public function it_orders_by_sizes_asc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createColorSizeProduct();
        $category = $this->createCustomCategory('Audio y altavoces');
        $subcategory = $this->createCustomSubcategory($category->id, 'Audio');
        $brand = $category->brands()->create(['name' => 'Apple']);
        $product = $this->createCustomProduct('Cascos', $subcategory, $brand, 1);
        Color::create(['name' => 'Azul']);
        $product->colors()->attach([1 => ['quantity' => 20]]);
        $size = Size::create(['name' => 'S', 'product_id'=>$product->id]);
        $size->colors()->attach([1 => ['quantity' => 20]]);

        $this->actingAs($admin)->get('/admin/products2?sortColumn=sizes.name&sortDirection=asc')
            ->assertOk()
            ->assertSeeInOrder([$product->name,$product1->name]);
    }

    /** @test */
    public function it_orders_by_sizes_at_desc()
    {
        $admin = $this->createAdmin();
        $product1 = $this->createColorSizeProduct();
        $category = $this->createCustomCategory('Audio y altavoces');
        ...
        $this->actingAs($admin)->get('/admin/products2?sortColumn=sizes.name&sortDirection=desc')
            ->assertOk()
            ->assertSeeInOrder([$product1->name,$product->name]);
    }
}
